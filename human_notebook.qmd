...
<!--% Interprétation statistique et biologique --> Il y a une différence significative entre les moyennes des personnes qui consoment régulièrement et jamais à rarement du scure au seuil alpha de 5% (ANOVA, Ddl =2&141, F = 4.81 et P-value= 0.00949
...
```{r test_anova2_1}
biometrya2f1 <- lm(data = biometry, bmi ~ eau_rec*Conso_cig)
anova(biometrya2f1) %>.%
  tabularise(.)
