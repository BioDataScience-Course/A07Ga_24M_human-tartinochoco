...
chart(biometry, masse_corr~genre %fill=% alimentation)+
  geom_boxplot()+
  scale_fill_manual(values = c("mediumorchid1", "lightcoral", "lightgreen"))+
  stat_summary(fun.data=give_n2, geom= "text", hjust = 0.5, position = position_dodge(0.75))
```

Analyse: Les omnivores sont prépondérants, tandis que les régimes carnivores et végétariens sont beaucoup plus rares. De plus, notre échantillon ne contient aucun homme végétarien.
