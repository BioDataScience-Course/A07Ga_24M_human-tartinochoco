---
title: "L'influence de ... sur l'obésité "
...
Le but de cette recherche est de déterminer les différents facteurs qui influencent l'apparition de l'obésité chez les personnes âgées de 18 à 80 ans.
Cette étude se concentre sur l’aspect nutritionnel lié à l’obésité. L’objectif est d’évaluer l’impact de la consommation en fast-food,  sucre et eau sur les deux grandes valeurs indicatrices utilisés pour évaluer l’obésité.
...
Les descriptions et analyses statistiques ont été réalisées sur RStudio dans sa version 4.3.0 sur la SciViews Box 2024 via la plateforme SaturnCloud (https://saturncloud.io). Cette étude se base sur différents tests d’hypothèses. 
...
#post hoc
tabularise(summary(sucre_confint<-confint(multcomp::glht(sucre_lm, linfct=multcomp::mcp(sucre_rec="Tukey")))))
