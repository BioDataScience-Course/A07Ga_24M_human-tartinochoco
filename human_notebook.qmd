...
H0 = Aucun rapport entre la durée du sommeil et l'indice de rondeur corporelle

H1= Rapport entre la durée du sommeil et l'indice de rondeur corporelle

<!-- Vérification des conditions d'application -->

```{r test_t_1}
#test
t.test(data= biometry, log_IRC~sommeil_rec , alternative="two.sided", conf.level= 0.95, var.equal = TRUE)
```
